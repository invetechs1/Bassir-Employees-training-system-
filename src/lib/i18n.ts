...
export const DICT: Record<string, Entry> = {
  ...
  "course.lessons": { en: "lessons", ar: "دروس" },
  "course.lesson": { en: "Lesson", ar: "الدرس" },
  "course.min": { en: "min", ar: "د" },
  "course.yourProgress": { en: "Your progress", ar: "تقدّمك" },
  "course.start": { en: "Start course", ar: "ابدأ الدورة" },
  "course.continue": { en: "Continue", ar: "أكمل" },
  "course.review": { en: "Review", ar: "مراجعة" },
  "course.view": { en: "View course", ar: "عرض الدورة" },
  "course.noContent": { en: "This program has no content yet.", ar: "لا يحتوي هذا البرنامج على محتوى بعد." },
  "course.markComplete": { en: "Mark as complete", ar: "وضع علامة مكتمل" },
  "course.markIncomplete": { en: "Mark as not complete", ar: "إلغاء علامة الاكتمال" },
  "course.previous": { en: "Previous", ar: "السابق" },
  "course.next": { en: "Next lesson", ar: "الدرس التالي" },
  "course.backToProgram": { en: "Back to program", ar: "العودة إلى البرنامج" },
  "course.videoLesson": { en: "This lesson is a video.", ar: "هذا الدرس عبارة عن فيديو." },
  "course.resourceLesson": { en: "This lesson links to an external resource.", ar: "يرتبط هذا الدرس بمصدر خارجي." },
  "course.watch": { en: "Watch video", ar: "مشاهدة الفيديو" },
  "course.open": { en: "Open resource", ar: "فتح المصدر" },
  "ltype.TEXT": { en: "Reading", ar: "قراءة" },
  "ltype.VIDEO": { en: "Video", ar: "فيديو" },
  "ltype.RESOURCE": { en: "Resource", ar: "مصدر" },
  "ltype.QUIZ": { en: "Quiz", ar: "اختبار" },
  // Department → training track mapping
  "dept.link": { en: "Department tracks", ar: "مسارات الأقسام" },
  "dept.title": { en: "Department training tracks", ar: "مسارات تدريب الأقسام" },
  "dept.subtitle": { en: "Map each department to a course track. New hires are auto-enrolled into that track's published courses.", ar: "اربط كل قسم بمسار تدريبي. يُسجَّل الموظفون الجدد تلقائيًا في دورات ذلك المسار المنشورة." },
  "dept.none": { en: "No departments yet. Create departments to map training tracks.", ar: "لا توجد أقسام بعد. أنشئ أقسامًا لربط المسارات التدريبية." },
  "dept.department": { en: "Department", ar: "القسم" },
  "dept.members": { en: "Members", ar: "الأعضاء" },
  "dept.track": { en: "Training track", ar: "المسار التدريبي" },
  "dept.backfill": { en: "Existing members", ar: "الأعضاء الحاليون" },
  "dept.noTrack": { en: "— No track —", ar: "— بلا مسار —" },
  "dept.save": { en: "Save", ar: "حفظ" },
  "dept.assignNow": { en: "Assign now", ar: "سجّل الآن" },
  "dept.hint": { en: "Auto-assignment runs when an invited employee accepts. Use \"Assign now\" to enroll employees who are already active.", ar: "يعمل التسجيل التلقائي عند قبول الموظف المدعو للدعوة. استخدم \"سجّل الآن\" لتسجيل الموظفين النشطين حاليًا." },
  // Quiz player
  "quiz.intro": { en: "Answer the questions below. You need to score at least", ar: "أجب عن الأسئلة أدناه. تحتاج إلى تحقيق ما لا يقل عن" },
  "quiz.submit": { en: "Submit answers", ar: "إرسال الإجابات" },
  "quiz.retake": { en: "Retake quiz", ar: "إعادة الاختبار" },
  "quiz.passed": { en: "Passed — well done!", ar: "ناجح — أحسنت!" },
  "quiz.failed": { en: "Not passed yet — review and try again.", ar: "لم تنجح بعد — راجع وحاول مجددًا." },
  "quiz.score": { en: "Score", ar: "النتيجة" },
  "quiz.passMark": { en: "Pass mark", ar: "درجة النجاح" },
  "quiz.correct": { en: "Correct", ar: "صحيح" },
  "quiz.incorrect": { en: "Incorrect", ar: "خطأ" },
  "quiz.explanation": { en: "Explanation", ar: "التوضيح" },
  "quiz.chooseAll": { en: "Choose one answer per question.", ar: "اختر إجابة واحدة لكل سؤال." },
  "quiz.alreadyPassed": { en: "You have already passed this quiz.", ar: "لقد اجتزت هذا الاختبار بالفعل." },
  "track.Accounting & Finance": { en: "Accounting & Finance", ar: "المحاسبة والمالية" },
