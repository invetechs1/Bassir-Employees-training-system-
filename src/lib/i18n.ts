...
export const DICT: Record<string, Entry> = {
  ...
  "cert.view": { en: "Certificate", ar: "الشهادة" },
  "cert.print": { en: "Print / Save as PDF", ar: "طباعة / حفظ PDF" },
  "cert.title": { en: "Certificate of Completion", ar: "شهادة إتمام" },
  "cert.presentedTo": { en: "This certifies that", ar: "تشهد هذه الوثيقة بأن" },
  "cert.forCompleting": { en: "has successfully completed", ar: "قد أتمّ بنجاح" },
  "cert.date": { en: "Date", ar: "التاريخ" },
  "cert.score": { en: "Score", ar: "النتيجة" },
  "cert.serial": { en: "Serial", ar: "الرقم التسلسلي" },
  "cert.footer": { en: "Issued by the BASSIR Corporate Academy Platform. Verify with the serial above.", ar: "صادرة عن منصة بشير للأكاديمية المؤسسية. تحقّق باستخدام الرقم التسلسلي أعلاه." },
  "cert.notEarned": { en: "No certificate yet — finish the course to earn one.", ar: "لا توجد شهادة بعد — أكمل الدورة للحصول عليها." },
  // Monthly development report / KPI
  "report.link": { en: "Reports", ar: "التقارير" },
  "report.title": { en: "Development report", ar: "تقرير التطوير" },
  "report.subtitle": { en: "Monthly development KPI per employee — who is growing, and who isn't.", ar: "مؤشر تطوير شهري لكل موظف — من يتطوّر ومن لا يتطوّر." },
  "report.prev": { en: "Previous", ar: "السابق" },
  "report.next": { en: "Next", ar: "التالي" },
  "report.employee": { en: "Employee", ar: "الموظف" },
  "report.department": { en: "Department", ar: "القسم" },
  "report.lessons": { en: "Lessons", ar: "الدروس" },
  "report.quizzes": { en: "Quizzes", ar: "الاختبارات" },
  "report.courses": { en: "Courses", ar: "الدورات" },
  "report.certs": { en: "Certs", ar: "الشهادات" },
  "report.kpi": { en: "KPI", ar: "المؤشر" },
  "report.engagement": { en: "Engagement", ar: "التفاعل" },
  "report.eng.HIGH": { en: "High", ar: "مرتفع" },
  "report.eng.MEDIUM": { en: "Medium", ar: "متوسط" },
  "report.eng.LOW": { en: "Low", ar: "منخفض" },
  "report.eng.INACTIVE": { en: "Inactive", ar: "غير نشط" },
  "report.hint": { en: "KPI = lessons×1 + quizzes passed×3 + courses completed×10, counted within the selected month. Cert count shows this month (all-time).", ar: "المؤشر = الدروس×١ + الاختبارات المجتازة×٣ + الدورات المكتملة×١٠ خلال الشهر المحدد. عدد الشهادات يعرض هذا الشهر (والإجمالي)." },
  // Per-employee report
  "empr.enrolled": { en: "Enrolled", ar: "مُسجّل" },
  "empr.completed": { en: "Completed", ar: "مكتمل" },
  "empr.inProgress": { en: "In progress", ar: "قيد التقدم" },
  "empr.certificates": { en: "Certificates", ar: "الشهادات" },
  "empr.noCerts": { en: "No certificates earned yet.", ar: "لم يحصل على شهادات بعد." },
  "empr.viewCert": { en: "View certificate", ar: "عرض الشهادة" },
  "empr.courses": { en: "Courses", ar: "الدورات" },
  // Quiz player
